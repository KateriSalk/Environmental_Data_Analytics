...
O3.onesample
#the p value is very small, it supports us to reject the null hypo

```

What information does the output give us? How might we report this information in a report?

> ANWSER: Ozone AQI values in 2017-2018 were significantly lower than 50 (one sample t-test; t = -41.9. df = 1084, p < 0.001).

Always think about what your outcome tells you about.
...
O3.twosample 
#The result tells us there is a significant difference in those two groups
...
#pair bryson and black, pair triple and black have significantly different means
...
> ANSWER: Blackstone has overall higher PM2.5 than bryson and triple oak (ANOVA; F = 16.16, df = 1898, p < 0.0001)
...
#the result shows TN = 309.39(paul lake, depth id 1)  +105.29  +97.28
