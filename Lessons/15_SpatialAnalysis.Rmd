...
#install.packages('sf')
library(sf)
#library("sf", lib.loc="D:/R/R-3.5.2/library")
...
huc0302 <- huc2_utm %>% 
  filter(SUB == '0302')  # SUB/FILPS code are usually stored as factors
