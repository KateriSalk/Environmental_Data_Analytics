...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{EPA_O3_NC2017 <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/EPAair_O3_NC2017_raw.csv"}\NormalTok{)}
\NormalTok{EPA_O3_NC2018 <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/EPAair_O3_NC2018_raw.csv"}\NormalTok{)}
\NormalTok{EPA_pm25_NC2017 <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/EPAair_PM25_NC2017_raw.csv"}\NormalTok{)}
\NormalTok{EPA_pm25_NC2018 <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/EPAair_PM25_NC2018_raw.csv"}\NormalTok{)}

\CommentTok{#2}
\CommentTok{#data summaries for O3 2017}
\KeywordTok{head}\NormalTok{(EPA_O3_NC2017)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{#3}
\KeywordTok{class}\NormalTok{(EPA_O3_NC2017}\OperatorTok{$}\NormalTok{Date)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{class}\NormalTok{(EPA_pm25_NC2017}\OperatorTok{$}\NormalTok{Date)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{class}\NormalTok{(EPA_pm25_NC2018}\OperatorTok{$}\NormalTok{Date)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{EPA_O3_NC2017}\OperatorTok{$}\NormalTok{Date <-}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(EPA_O3_NC2017}\OperatorTok{$}\NormalTok{Date, }\DataTypeTok{format =} \StringTok{"%m/%d/%y"}\NormalTok{)}
...
\NormalTok{EPA_pm25_NC2017}\OperatorTok{$}\NormalTok{Date <-}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(EPA_pm25_NC2017}\OperatorTok{$}\NormalTok{Date, }\DataTypeTok{format =} \StringTok{"%m/%d/%y"}\NormalTok{)}
\NormalTok{EPA_pm25_NC2018}\OperatorTok{$}\NormalTok{Date <-}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(EPA_pm25_NC2018}\OperatorTok{$}\NormalTok{Date, }\DataTypeTok{format =} \StringTok{"%m/%d/%y"}\NormalTok{)}

\CommentTok{#4}
\NormalTok{EPA_O3_NC2017.sel <-}\StringTok{ }\KeywordTok{select}\NormalTok{(EPA_O3_NC2017, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)}
\NormalTok{EPA_O3_NC2018.sel <-}\StringTok{ }\KeywordTok{select}\NormalTok{(EPA_O3_NC2018, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)}
\NormalTok{EPA_pm25_NC2017.sel <-}\StringTok{ }\KeywordTok{select}\NormalTok{(EPA_pm25_NC2017, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)}
\NormalTok{EPA_pm25_NC2018.sel <-}\StringTok{ }\KeywordTok{select}\NormalTok{(EPA_pm25_NC2018, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)}

\CommentTok{#5}
\NormalTok{EPA_pm25_NC2017.sel}\OperatorTok{$}\NormalTok{AQS_PARAMETER_DESC <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"PM2.5"}\NormalTok{)}
\NormalTok{EPA_pm25_NC2018.sel}\OperatorTok{$}\NormalTok{AQS_PARAMETER_DESC <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"PM2.5"}\NormalTok{)}

\CommentTok{#6}
\KeywordTok{write.csv}\NormalTok{(EPA_O3_NC2017.sel, }\DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{, }\DataTypeTok{file =} \StringTok{"./Data/Processed/EPA_O3_NC2017_sel_Processed.csv"}\NormalTok{)}
\KeywordTok{write.csv}\NormalTok{(EPA_O3_NC2018.sel, }\DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{, }\DataTypeTok{file =} \StringTok{"./Data/Processed/EPA_O3_NC2018_sel_Processed.csv"}\NormalTok{)}
\KeywordTok{write.csv}\NormalTok{(EPA_pm25_NC2017.sel, }\DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{, }\DataTypeTok{file =} \StringTok{"./Data/Processed/EPA_pm2.5_NC2017_sel_Processed.csv"}\NormalTok{)}
\KeywordTok{write.csv}\NormalTok{(EPA_pm25_NC2018.sel, }\DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{, }\DataTypeTok{file =} \StringTok{"./Data/Processed/EPA_pm2.5_NC2018_sel_Processed.csv"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{#7}
\NormalTok{EPA_AQ_NC <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(EPA_O3_NC2017.sel, EPA_O3_NC2018.sel,EPA_pm25_NC2017.sel,EPA_pm25_NC2018.sel)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{EPA_AQ_NC_summary <-}\StringTok{ }
\StringTok{  }\NormalTok{EPA_AQ_NC }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(Site.Name }\OperatorTok{==}\StringTok{ "Blackstone"} \OperatorTok{|}\NormalTok{Site.Name }\OperatorTok{==}\StringTok{ "Bryson City"} \OperatorTok{|}\NormalTok{Site.Name }\OperatorTok{==}\StringTok{ "Triple Oak"}\NormalTok{ ) }\OperatorTok{%>%}
...
\KeywordTok{head}\NormalTok{(EPA_AQ_NC_summary)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{#9}
\NormalTok{EPA_AQ_NC_Spread <-}\StringTok{ }\KeywordTok{spread}\NormalTok{(EPA_AQ_NC_summary, AQS_PARAMETER_DESC, DAILY_AQI_VALUE)}
\KeywordTok{head}\NormalTok{(EPA_AQ_NC_Spread)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{#10}
\KeywordTok{dim}\NormalTok{(EPA_AQ_NC_Spread)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{#11}
\KeywordTok{write.csv}\NormalTok{(EPA_AQ_NC_Spread, }\DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{, }\DataTypeTok{file =} \StringTok{"./Data/Processed/EPA_AQ_NC_Spread_Processed.csv"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{#12a}
\NormalTok{EPA_AQ_NC_mean<-}
\StringTok{  }\NormalTok{EPA_AQ_NC_Spread }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(month) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{meanO3 =} \KeywordTok{mean}\NormalTok{(}\KeywordTok{na.omit}\NormalTok{(Ozone)),}
              \DataTypeTok{meanPM2.5 =} \KeywordTok{mean}\NormalTok{(}\KeywordTok{na.omit}\NormalTok{(PM2.}\DecValTok{5}\NormalTok{))) }
...
\StringTok{    }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{meanO3 =} \KeywordTok{mean}\NormalTok{(}\KeywordTok{na.omit}\NormalTok{ (Ozone)),}
              \DataTypeTok{minO3 =} \KeywordTok{min}\NormalTok{(}\KeywordTok{na.omit}\NormalTok{ (Ozone)),}
              \DataTypeTok{maxO3 =} \KeywordTok{max}\NormalTok{(}\KeywordTok{na.omit}\NormalTok{ (Ozone)),}
              \DataTypeTok{meanPM2.5 =} \KeywordTok{mean}\NormalTok{ (}\KeywordTok{na.omit}\NormalTok{ (PM2.}\DecValTok{5}\NormalTok{)),}
              \DataTypeTok{minPM2.5 =} \KeywordTok{min}\NormalTok{ (}\KeywordTok{na.omit}\NormalTok{ (PM2.}\DecValTok{5}\NormalTok{)),}
              \DataTypeTok{maxPM2.5 =} \KeywordTok{max}\NormalTok{ (}\KeywordTok{na.omit}\NormalTok{ (PM2.}\DecValTok{5}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
